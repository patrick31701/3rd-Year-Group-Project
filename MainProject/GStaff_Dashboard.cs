...
{
    //Made by Jakub
    public partial class GStaff_Dashboard : Form
    {
        ...
        #endregion
        #region Constructors
        public GStaff_Dashboard(User_Login staff, IModel Model, string loginID)
        {
            InitializeComponent();
            ULogin = staff;
            this.Model = Model;
        ...
        private void changedProducts(object sender, EventArgs e)
        {
